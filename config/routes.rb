...
Rails.application.routes.draw do
  ...
  match "/api/v1/domains/create" => "legacy_api/domain_api#create", via: [:get, :post, :patch, :put]
  match "/api/v1/domains/query" => "legacy_api/domain_api#query", via: [:get, :post, :patch, :put]
  match "/api/v1/domains/check" => "legacy_api/domain_api#check", via: [:get, :post, :patch, :put]
  match "/api/v1/domains/delete" => "legacy_api/domain_api#delete", via: [:get, :post, :patch, :put]
